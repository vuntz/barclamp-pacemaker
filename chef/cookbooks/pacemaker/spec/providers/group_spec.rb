...
describe "Chef::Provider::PacemakerGroup" do
  ...
  describe ":create action" do
    ...
    it "should modify the resource if it has a resource added" do
      new_resource = 'bar:Stopped'
      expected = fixture.dup
      expected.members = expected.members.dup + [new_resource]
    ...
    it "should modify the resource if it has a different resource" do
      new_members = ['bar:Started']
      fixture.members = new_members
      expected_configure_cmd_args = [fixture.reconfigure_command]
      test_modify(expected_configure_cmd_args) do
        @resource.members new_members
      end
    end
